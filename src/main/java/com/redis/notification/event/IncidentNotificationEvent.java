...
public class IncidentNotificationEvent extends NotificationEvent {

    public IncidentNotificationEvent(Object source, Long userId, String title, String message,
                                     NotificationChannel channel, NotificationPriority priority) {
        super(source, userId, title, message, channel, priority, NotificationType.INCIDENT);
    }
}
