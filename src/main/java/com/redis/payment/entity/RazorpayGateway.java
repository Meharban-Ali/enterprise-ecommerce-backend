...
public class RazorpayGateway implements PaymentGateway {
        ...
        return PaymentResponse.builder()
                ...
                .transactions(Collections.singletonList(
                        PaymentTransactionResponse.builder()
                                .gatewayReferenceId("razorpay_order_placeholder_" + payment.getId())
                                .type("AUTHORIZE")
                                .amount(payment.getAmount())
        ...
        return PaymentResponse.builder()
                ...
                .refunds(Collections.singletonList(
                        RefundResponse.builder()
                                ...
                                .status("SUCCESS")
                                .reason(reason)
                                .gatewayReferenceId("razorpay_refund_placeholder_" + payment.getId())
                                .createdAt(LocalDateTime.now())
                                .build()
                ))
                .createdAt(LocalDateTime.now())
    ...
    public com.redis.payment.entity.PaymentGateway getGatewayName() {
        return com.redis.payment.entity.PaymentGateway.RAZORPAY;
    }
}
