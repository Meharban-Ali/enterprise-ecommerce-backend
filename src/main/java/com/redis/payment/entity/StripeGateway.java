...
public class StripeGateway implements PaymentGateway {
        ...
        return PaymentResponse.builder()
                ...
                .transactions(Collections.singletonList(
                        PaymentTransactionResponse.builder()
                                .gatewayReferenceId("stripe_session_placeholder_" + payment.getId())
                                .type("AUTHORIZE")
                                .amount(payment.getAmount())
        ...
        return PaymentResponse.builder()
                ...
                .refunds(Collections.singletonList(
                        RefundResponse.builder()
                                ...
                                .status("SUCCESS")
                                .reason(reason)
                                .gatewayReferenceId("stripe_refund_placeholder_" + payment.getId())
                                .createdAt(LocalDateTime.now())
                                .build()
                ))
                .createdAt(LocalDateTime.now())
    ...
    public com.redis.payment.entity.PaymentGateway getGatewayName() {
        return com.redis.payment.entity.PaymentGateway.STRIPE;
    }
}
